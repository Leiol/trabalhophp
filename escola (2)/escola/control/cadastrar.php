...
<?php
  ...
  }elseif (isset($_POST['cadSala']) and $_POST['cadSala']=="1"){
	      require_once "conexao.php";
	      require_once "../model/sala.class.php";
		  $sala = new Sala($_POST['nome'],$_POST['escola']);
		  try { 
			 $comandoSQL = "INSERT INTO tbsala (tbSalaNome,tbSalaEscola) 
			 VALUES ('".$sala->getNome()."','".$sala->getEscola()."' )";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
  ...
  } elseif (isset($_POST['cadFuncionario']) and $_POST['cadFuncionario']=="1"){
	      require_once "conexao.php";
	      require_once "../model/funcionario.class.php";
		  $funcionario = new Funcionario($_POST['nome'],$_POST['escola'], $_POST['funcao']);
		  try { 
			 $comandoSQL = "INSERT INTO tbfuncionario (tbFuncionarioNome,tbFuncionarioEscola, tbFuncionarioFuncao) 
			 VALUES ('".$funcionario->getNome()."','".$funcionario->getEscola()."', '".$funcionario->getFuncao()."' )";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
  ...
  } elseif (isset($_POST['cadDisciplina']) and $_POST['cadDisciplina']=="1"){
	      require_once "conexao.php";
	      require_once "../model/disciplina.class.php";
  $disciplina = new Disciplina($_POST['nome'], $_POST['sala']);
		  try { 
			 $comandoSQL = "INSERT INTO tbdisciplina (tbDisciplinaNome, tbDisciplinaSala) VALUES ('".$disciplina->getNome()."', '".$disciplina->getSala()."')";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
  ...
  }		 elseif (isset($_POST['cadTurma']) and $_POST['cadTurma']=="1"){
	      require_once "conexao.php";
	      require_once "../model/turma.class.php";
		  $turma = new Turma($_POST['disciplina'],$_POST['professor'],$_POST['nome']);
		  try { 
			 $comandoSQL = "INSERT INTO tbturma (tbTurmaDisciplina,tbTurmaProfessor, tbTurmaNome) VALUES ('".$turma->getDisciplina()."','".$turma->getProfessor()."','".$turma->getNome()."')";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
  ...
  } 		 elseif (isset($_POST['cadProfessor']) and $_POST['cadProfessor']=="1"){
	      require_once "conexao.php";
  ...
  elseif (isset($_POST['cadAluno']) and $_POST['cadAluno']=="1"){
	      require_once "conexao.php";
		  ...
		  }elseif (isset($_POST['cadCurso']) and $_POST['cadCurso']=="1"){
	      require_once "conexao.php";
		  ...
		  }elseif (isset($_POST['cadFuncao']) and $_POST['cadFuncao']=="1"){
	      require_once "conexao.php";
		  ...
		  }elseif (isset($_POST['cadMatricula']) and $_POST['cadMatricula']=="1"){
	      require_once "conexao.php";
	      require_once "../model/matricula.class.php";
		  $matricula = new Matricula($_POST['aluno'], $_POST['turma'], $_POST['nome']);
		  try { 
			 $comandoSQL = "INSERT INTO tbmatricula (tbMatriculaAluno, tbMatriculaTurma, tbMatriculaNome) VALUES ('".$matricula->getAluno()."', '".$matricula->getTurma()."', '".$matricula->getNome()."')";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
						Curso cadastrado com sucesso!
		  ...
		  }elseif (isset($_POST['cadFinanceira']) and $_POST['cadFinanceira']=="1"){
	      require_once "conexao.php";
	      require_once "../model/financeira.class.php";
		  $financeira = new Financeira($_POST['aluno'], $_POST['curso'], $_POST['nome']);
		  try { 
			 $comandoSQL = "INSERT INTO tbfinanceira (tbFinanceiraAluno, tbFinanceiraCurso, tbFinanceiraNome) VALUES ('".$financeira->getAluno()."', '".$financeira->getCurso()."', '".$financeira->getNome()."')";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
		  ...
		  } elseif (isset($_POST['cadAvaliacao']) and $_POST['cadAvaliacao']=="1"){
	      require_once "conexao.php";
	      require_once "../model/avaliacao.class.php";
		  $avaliacao = new Avaliacao($_POST['n1'],$_POST['n2'],$_POST['matricula']);
		  try { 
			 $comandoSQL = "INSERT INTO tbavaliacao (tbAvaliacaoN1,tbAvaliacaoN2, tbAvaliacaoMatricula) VALUES ('".$avaliacao->getNota1()."','".$avaliacao->getNota2()."', '".$avaliacao->getMatricula()."' )";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
  ...
  } elseif (isset($_POST['cadPagamentos']) and $_POST['cadPagamentos']=="1"){
	      require_once "conexao.php";
	      require_once "../model/pagamentos.class.php";
		  $pagamentos = new Pagamentos($_POST['valor'],$_POST['data'],$_POST['financeira'],$_POST['nome']);
		  try { 
			 $comandoSQL = "INSERT INTO tbpagamento (tbPagamentoValor,tbPagamentoData, tbPagamentoFinanceira, tbPagamentoNome) VALUES ('".$pagamentos->getValor()."','".$pagamentos->getData()."', '".$pagamentos->getFinanceira()."', '".$pagamentos->getNome()."')";
			 $grava = $pdo->prepare($comandoSQL);
			 $grava->execute(array()); 	                                        
			 echo '<br/><div class="alert alert-success" role="alert">
